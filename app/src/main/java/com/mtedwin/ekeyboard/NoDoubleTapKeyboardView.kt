...
class NoDoubleTapKeyboardView constructor(
    ...
    // For potential future use if we want to implement custom long-press or repeat behavior
    private var longPressJob: Job? = null
    private val longPressTimeout = 500L // ms
    ...
    interface OnKeyLongPressListener {
        fun onKeyLongPressed(key: Keyboard.Key)
        fun onKeyReleased(primaryCode: Int)
    }
    ...
    override fun onLongPress(key: Keyboard.Key): Boolean {
        ...
        // Notify the listener about long press

        onKeyLongPressListener?.onKeyLongPressed(key)
        return true
    }
